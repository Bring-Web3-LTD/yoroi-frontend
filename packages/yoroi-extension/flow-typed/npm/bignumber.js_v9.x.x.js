...
declare module "bignumber.js" {
   ...
   */
  declare interface BigNumber$Config {
    /**
   ...
   */
  declare interface BigNumber$Format {
    /**
  ...
  declare interface BigNumber$Instance {
    /**
  ...
  declare type BigNumber$Constructor = typeof BigNumber;

  declare type BigNumber$ModuloMode = 0 | 1 | 3 | 6 | 9;

  declare type BigNumber$RoundingMode = 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8;

  declare type BigNumber$Value = string | number | BigNumber$Instance;
  declare export class BigNumber implements BigNumber$Instance {
    /**
     * The coefficient of the value of this BigNumber, an array of base 1e14 integer numbers, or null.
     */
    c: number[] | null;
